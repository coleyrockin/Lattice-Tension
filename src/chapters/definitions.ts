...
export const CHAPTERS: ChapterDefinition[] = [
  ...
  // NEW REALMS for Aether Atlas — multi-universe expansion. Ranges extend beyond 1 for additional scroll depth (total ~11 sections). New sim fields defaulted; resonance carry-over high.
  {
    id: "interference",
    index: 6,
    title: "Interference",
  ...
  },
  {
    ...
    fragment: "01 is favorite; this core echoes its gentle birth, unique in its warm pull and infinite soft lattice.",
    range: [1.833, 2.0],
